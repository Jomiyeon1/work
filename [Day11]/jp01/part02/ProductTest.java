...
public class ProductTest{
	  ...
	  public static void main(String[] args){
			...
			p03.product="사이다";
			System.out.println("p01.product : "+p01.product); //사
			System.out.println("p02.product : "+p02.product); //콜
			System.out.println("p03.product : "+p03.product); //사

			p02 = p03;
			System.out.println("p01.product : "+p01.product); //사
			System.out.println("p02.product : "+p02.product); //사
			System.out.println("p03.product : "+p03.product); //사
		}//end of main
