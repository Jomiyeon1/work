...
/*
 FileName : PrimitiveTset.java
 
 1. Java에서 제공되는 8EA의 Primitiver Data type의 이해
...
public class PrimitiveTest{
 //main method
  public static void main(String[] args){
	...
	//정수형
	byte b = 127;
	//범위를 넘어서는 수를 담을 경우 문제 발생 // ==> compile error 발생(확인 요망)
	// byte b1 = 128;
	...
	//실수형
	float f = 1000.5F;  //<== float의 경유 000F 또는 000f로 double와 구별
	double d = 1000.5;

	// print()와 println()의 차이점 <== 실행 결과를 확인함
