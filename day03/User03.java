...
class User03 {
	...
	public User03(String str){
		System.out.println("String 인자를 받아 name을 초기화하는 생성자");
		name = str;
	}
	...
	public User03(String str, int i){
		System.out.println("String, int 인자를 받아 name, javaLevel을 초기화하는 생성자");
		name = str;
		javaLevel = i;
	}
	...
	public static void main(String[] args) {
		...
		// => 상태값을 설정하지않은(초기화하지않은) javaLevel의 출력 값은?
